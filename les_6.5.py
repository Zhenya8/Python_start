...
class Pen(Stationery):
    def draw(self):
        print(f'Starting drawing with a {self.title} pen.')


class Pencil(Stationery):
    def draw(self):
        print(f'Starting drawing with a {self.title} pencil')


class Handle(Stationery):
    def draw(self):
        print(f'Starting drawing with a {self.title} handle.')
